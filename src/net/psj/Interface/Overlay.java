...
public class Overlay {
	...
	public static void drawInfoBar() {
		...
		RenderUtils.drawFont(4, 6, "PowderSimJ version " + PowderSimJ.version
	...
	public static void drawPixInfo() {
		...
		String text = "X: " + x + " Y: " + y;
		RenderUtils.drawFont(w - RenderUtils.getFontWidth(text), 6, text, 1.0f,
				1.0f, 1.0f);
		...
		if (PowderSimJ.isInPlayField(x, y)) {
			...
			RenderUtils.drawFont(w - RenderUtils.getFontWidth(text2), 14,
			...
			if (ParticleData.parts[ParticleData.pmap[y][x]] != null) {
				...
				RenderUtils.drawFont(w - RenderUtils.getFontWidth(text3), 22,
		...
		if (PowderSimJ.Debug) {
			...
			RenderUtils.drawFont(w - RenderUtils.getFontWidth(text4), height,
